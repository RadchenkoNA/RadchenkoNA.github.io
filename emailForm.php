...
if (isset($_POST['email'])) {
    ...
    $email_to = "n.a.radchenko@lse.ac.uk";
    $email_subject = "You've got a new submission";

    function problem($error)
    {
        echo "Uh-oh, looks like there is some problem with your form data: <br><br>";
        echo $error . "<br><br>";
    ...
    if (
        ...
        problem('Uh-oh, looks like there is some problem with your form data.');
    }
    ...
    if (!preg_match($string_exp, $name)) {
        $error_message .= 'Latin Letters only please<br>';
    }
